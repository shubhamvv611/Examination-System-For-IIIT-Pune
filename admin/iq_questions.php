...
<div  class="well" >Add IQ Questions Here <div class="pull-right"><a href="index.php"  ><button class="btn btn-danger "><span class="glyphicon glyphicon-off"></span></button></a></div> </div></div></br></br></br></br>
...
echo "$answer";
 ...
 mysqli_query($con,"INSERT INTO  iq(question,option1,option2,option3,option4,answer) 
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    mysqli_select_db($con,"examination");
    $sql = "insert into iq (question,option1,option2,option3,option4,answer) values(?,?,?,?,?,?)";
