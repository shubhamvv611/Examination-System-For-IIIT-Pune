...
<body>
<div  class="well " >List Of Physics  Questions <div class="pull-right"><a href="index.php" ><button class="btn btn-danger "><span class="glyphicon glyphicon-off"></span></button></a></div></div></br></br>
<div class="container">
<?php  
...
$con=mysqli_connect("localhost","root","","examination");
$query = "DELETE FROM physics WHERE ID={$_POST['delete']} LIMIT 1";
