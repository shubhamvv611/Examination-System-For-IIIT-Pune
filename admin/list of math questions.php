...
<head>
	...
	<title>List OF Math questions</title>
...
<body>
<div  class="well " >List Of Math Questions <div class="pull-right"><a href="index.php" ><button class="btn btn-danger "><span class="glyphicon glyphicon-off"></span></button></a></div></div></br></br>
<div class="container">
<?php  
...
$con=mysqli_connect("localhost","root","","examination");
$query = "DELETE FROM math WHERE ID={$_POST['delete']} LIMIT 1";
