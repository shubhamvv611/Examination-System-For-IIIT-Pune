...
<body style="background-color: white;">
	...
	<div id="non-printable" class="well " >Physcis , Chemistry And Maths Results <div class="pull-right"><a href="index.php" ><button class="btn btn-danger "><span class="glyphicon glyphicon-off"></span></button></a></div></div></br></br>
...
$sql="SELECT * FROM physics_chemistry_result WHERE date='$date' ORDER BY marks DESC   ";
echo "<div class='container'></br><center><img src='../images/IIIT.jpg'> </center></br><div><strong><center id='printable'>Physics  Chemistry & Math Examination Result - $date</center></strong></div></br>
		<center>
